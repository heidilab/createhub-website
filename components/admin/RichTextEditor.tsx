...
// ── Custom fontSize extension (TipTap 3 doesn't ship one) ────────────
...
const FONT_SIZES = [
  { label: "細", value: "12px" },
  { label: "正常", value: "" }, // clear
  { label: "大", value: "18px" },
  { label: "特大", value: "24px" },
  { label: "標題 1", value: "heading-1" },
  { label: "標題 2", value: "heading-2" },
  { label: "標題 3", value: "heading-3" },
  { label: "標題 4", value: "heading-4" },
  { label: "標題 5", value: "heading-5" },
];
...
export default function RichTextEditor({
  ...
  // Sync incoming value on mount (only once; further edits come from user)
  useEffect(() => {
  ...
  if (!editor) {
    return (
      <div
        className="input"
        style={{ minHeight }}
        aria-label="Rich text editor loading"
      />
    );
  }
  ...
  return (
    <div className="border border-brand-hair bg-white">
      ...
      <div className="p-3">
        ...
        {editor.isEmpty && (
          <div className="pointer-events-none text-brand-softer text-[13px] -mt-6 pl-1">
            {placeholder}
          </div>
        )}
      </div>
...
function Toolbar({ editor }: { editor: Editor }) {
  return (
    <div className="flex flex-wrap items-center gap-1 p-2 border-b border-brand-hair bg-brand-bg/50">
      {/* Font family */}
            ...
            <button
              ...
              onClick={() => {
                ...
                if (s.value.startsWith("heading-")) {
                  const lvl = Number(s.value.replace("heading-", "")) as
                    | 1
                    | 2
                    | 3
                    | 4
                  ...
                  // "正常" - clear fontSize AND any heading
                  chain
